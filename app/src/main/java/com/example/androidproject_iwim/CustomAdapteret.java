...
public class CustomAdapteret extends RecyclerView.Adapter<ViewHolder> {

    ListActivtyet listActivty;
    List<com.example.androidproject_iwim.Modelet> modelList;
    Context context;


    public CustomAdapteret(ListActivtyet listActivty, List<com.example.androidproject_iwim.Modelet> modelList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View itemView = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.model_layoutet, viewGroup, false);
                ...
                builder.setItems(options, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (which==0){
                            ...
                            Intent intent = new  Intent(listActivty,ajoutEtud.class);
