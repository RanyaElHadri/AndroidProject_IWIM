...
public class ListeMsgsDActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_liste_msgs_d);
        ...
        mHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent homeActivityIntent = new Intent(ListeMsgsDActivity.this, EspaceDelegue.class);
