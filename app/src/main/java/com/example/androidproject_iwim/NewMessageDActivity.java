...
public class NewMessageDActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_message_d);
    ...
    private void startPosting(){
        ...
        if (!TextUtils.isEmpty(text_val)){
            ...
            startActivity(new Intent(NewMessageDActivity.this,ListeMsgsDActivity.class));
