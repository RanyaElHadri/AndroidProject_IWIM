...
public class ListeEventsDActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_liste_events_d);
        ...
        mHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent homeActivityIntent = new Intent(ListeEventsDActivity.this, EspaceDelegue.class);
