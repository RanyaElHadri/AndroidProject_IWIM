...
public class ListesMsgsProfMsgsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listes_msgs_prof_msgs);
        ...
        mHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent homeActivityIntent = new Intent(ListesMsgsProfMsgsActivity.this, ProfActivity.class);
