...
public class NewEventDActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_event_d);
        ...
        mSubmitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mEventTask != null && mEventTask.isInProgress()){
                    Toast.makeText(NewEventDActivity.this,"Création en cours",Toast.LENGTH_SHORT).show();
                }else{
                    startPosting();
                }
            }
        ...
        if (!TextUtils.isEmpty(title_val) && !TextUtils.isEmpty(desc_val) && mImageUri!= null){
            ...
            mEventTask = filepath.putFile(mImageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    startActivity(new Intent(NewEventDActivity.this,ListeEventsDActivity.class));
